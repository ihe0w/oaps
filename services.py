...
class ArticleService:
    ...
    def calPopularity(self, article):
        return article.upvoteNum / max((article.upvoteNum + article.downvoteNum), 1) * (
                article.accessNum * 0.3 + article.commentNum * 0.7)
...
class CommentService:
    ...
    def upvote(self, comment_id, ip_id):
        # todo what's cip,comment?
        # cip comment-ip mapper
